 ...
 *
 * Vendored from github.com/facebook/openr/openr/if/Network.thrift.
...
struct NextHopThrift {
  ...
  /*
   * Cost associated with this nexthop. Mirrors `metric` (field 51) for FBOSS
   * FIB programming compatibility — FBOSS's NextHopThrift defines cost at
   * field ID 17.
   */
  ...
  // Area field associated with next-hop.
