...
/*
 * RouteFilter wrapper for SimRouteInfo objects.
 * Intercepts LOCAL_ROUTE metric to check origin == RouteOrigin::LOCAL,
 * mirroring the production RouteInfoFilter pattern.
 */
class SimRouteInfoFilter {
 public:
